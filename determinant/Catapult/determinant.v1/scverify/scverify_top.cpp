...
#define TOP_HDL_ENTITY determinant
#endif
...
public:
  ...
  sc_signal<sc_lv<153> >                                                  TLS_input_rsc_dat;
  sc_signal<sc_logic>                                                     TLS_input_rsc_triosy_lz;
  sc_signal<sc_lv<17> >                                                   TLS_result_rsc_dat;
  sc_signal<sc_logic>                                                     TLS_result_rsc_triosy_lz;
  ccs_DUT_wrapper                                                         determinant_INST;
  ccs_in_trans_rsc_v1<1,153 >                                             input_rsc_INST;
  ccs_out_trans_rsc_v1<1,17 >                                             result_rsc_INST;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<17, true >,9> >               TLS_in_fifo_input;
  tlm::tlm_fifo<mc_wait_ctrl>                                             TLS_in_wait_ctrl_fifo_input;
  mc_trios_input_monitor                                                  trios_monitor_input_rsc_triosy_lz_INST;
  mc_input_transactor<mgc_sysc_ver_array1D<ac_int<17, true >,9>,17,true>  transactor_input;
  tlm::tlm_fifo<ac_int<17, true > >                                       TLS_out_fifo_result;
  tlm::tlm_fifo<mc_wait_ctrl>                                             TLS_out_wait_ctrl_fifo_result;
  mc_trios_output_monitor                                                 trios_monitor_result_rsc_triosy_lz_INST;
  mc_output_transactor<ac_int<17, true >,17,true>                         transactor_result;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , determinant_INST("rtl", TO_QUOTED_STRING(TOP_HDL_ENTITY))
    ...
    , transactor_input("transactor_input", 0, 153, 0)
    ...
    , transactor_result("transactor_result", 0, 17, 0)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    determinant_INST.clk(clk);
    determinant_INST.rst(TLS_rst);
    determinant_INST.input_rsc_dat(TLS_input_rsc_dat);
    determinant_INST.input_rsc_triosy_lz(TLS_input_rsc_triosy_lz);
    determinant_INST.result_rsc_dat(TLS_result_rsc_dat);
    determinant_INST.result_rsc_triosy_lz(TLS_result_rsc_triosy_lz);
    ...
    result_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_2)));
    ...
    transactor_input.bind_clk(clk, true);
    ...
    transactor_result.bind_clk(clk, true);
