...
# Generated date: Sat Mar 19 19:12:34 EET 2022
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   MGC_HOME      /opt/catapult/Catapult_Synthesis_10.3d-815731/Mgc_home
#   PROJECT_HOME  /mnt/hgfs/P/high-level-synthesis/repo/determinant
#   SOLUTION_DIR  /mnt/hgfs/P/high-level-synthesis/repo/determinant/Catapult/determinant.v1
#   WORKING_DIR   /mnt/hgfs/P/high-level-synthesis/repo/determinant/Catapult/determinant.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult/determinant.v1
PROJ2SOLN = ./Catapult/determinant.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /mnt/hgfs/P/high-level-synthesis/repo/determinant/Catapult/determinant.v1/concat_sim_rtl.vhdl
endif
...
export SCVLIBS
export MODELSIM
TOP_HDL_ENTITY           := determinant
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./Catapult/determinant.v1/scverify_msim.tcl
...
CXX_SRC  = ../../determinant_tb.cpp/determinant_tb.cpp.cxxts ../../determinant.cpp/determinant.cpp.cxxts ./scverify/mc_testbench.cpp/mc_testbench.cpp.cxxts ./scverify/scverify_top.cpp/scverify_top.cpp.cxxts
...
CXXFLAGS += -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_determinant -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
...
$(TARGET)/determinant_tb.cpp.cxxts: ../../determinant_tb.cpp
$(TARGET)/determinant.cpp.cxxts: ../../determinant.cpp
...
$(TARGET)/determinant.cpp.cxxts: CXX_OPTS=
$(TARGET)/scverify_top.cpp.cxxts: CXX_OPTS=
$(TARGET)/mc_testbench.cpp.cxxts: CXX_OPTS=$(F_WRAP_OPT)
$(TARGET)/determinant_tb.cpp.cxxts: CXX_OPTS=
# 
# Specify dependencies
$(TARGET)/determinant_tb.cpp.cxxts: .ccs_env_opts/SCVerify_USE_CCS_BLOCK.ts
$(TARGET)/determinant.cpp.cxxts: .ccs_env_opts/SCVerify_USE_CCS_BLOCK.ts
...
$(TARGET)/concat_sim_rtl.vhdl.vhdlts: DUT_E=determinant
