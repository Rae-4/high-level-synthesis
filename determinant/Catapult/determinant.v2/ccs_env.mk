ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /opt/catapult/Catapult_Synthesis_10.3d-815731/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
ifeq "$(TCLSH_CMD)" ""
TCLSH_CMD                                           := /opt/catapult/Catapult_Synthesis_10.3d-815731/Mgc_home/bin/tclsh8.5
export TCLSH_CMD
endif
ifeq "$(ModelSim_Path)" ""
ModelSim_Path                                       := /opt/questa/questasim/bin
...
OSCI_SYSTEMC_INCLUDE                                := /opt/catapult/Catapult_Synthesis_10.3d-815731/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                    := /opt/catapult/Catapult_Synthesis_10.3d-815731/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                          := /opt/questa/questasim/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                           := 
